...
pwdd=`echo ~`
java -Xmx500G -D"java.library.path=$pwdd/ASTRAL/lib/" -jar $pwdd/ASTRAL/astralmp.5.17.2.jar -t 1 -q $1 -i inducedtrees.nwk -C -T 32 -o $1.qscore > astral.out 2> astral.err
